...
public class post {
    ...
    public static void post(){
        ...
        BossBar bossbar = LavaRising.gm.GamePlayer.customTimer(LavaRising.config.getInt("post.duration"), LavaRising.config.getString("post.timername"), BarColor.WHITE, BarStyle.SOLID, hashMap, new BukkitRunnable() {
            @Override
            public void run() {
